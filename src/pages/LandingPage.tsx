      ...
      <section className="hero-section">
        <div className="hero-container">
          <div className="hero-content">
            <h1 className="hero-title hero-title-container">
              <img src={logo} alt="Building Habit 로고" className="hero-logo" />
              <span>
                Building Habi<span className="hammer-icon">🔨</span>
              </span>
            </h1>
            <p className="hero-subtitle">작은 습관이 큰 변화를 만든다</p>
              ...
              <div className="mockup-screen">
                ...
                <div className="mockup-content">
                  <div className="mockup-habit-card">
                    <div className="habit-title">Running Everyday</div>
      ...
      <section className="problem-section">
        <div className="container">
          <div className="section-content">
            <h2 className="section-title">습관은 시작보다 유지가 어렵습니다</h2>
            <p className="section-subtitle">
              많은 사람들이 겪는 습관 형성의 어려움을 Building Habit이
              해결해드립니다
            </p>
            <div className="problem-grid">
              <div className="problem-item">
                ...
                <h3>목표를 잊는다</h3>
                <p>
                  시작할 때의 의욕이 시간이 지나면서 희미해지고, 왜 시작했는지
                  기억나지 않습니다.
                </p>
              </div>
              <div className="problem-item">
                ...
                <h3>진전을 확인하기 어렵다</h3>
                <p>
                  성취 과정을 눈으로 확인하기 어려워 동기부여가 떨어지고
                  포기하게 됩니다.
                </p>
              </div>
              <div className="problem-item">
                ...
                <h3>혼자 꾸준히 하기 힘들다</h3>
                <p>
                  외로운 여정 속에서 지속하기 어려운 상황에서 혼자만의 힘으로는
                  한계가 있습니다.
                </p>
              </div>
            </div>
          ...
          <div className="section-content">
            ...
            <div className="solution-grid">
              <div className="solution-item">
                ...
                <h3>쉽게 기록</h3>
                <p>
                  하루 한 번 체크로 간단하게 습관을 기록하고 관리할 수 있습니다.
                </p>
              </div>
              <div className="solution-item">
                <div className="solution-icon">📈</div>
                <h3>직관적인 시각화</h3>
                <p>
                  캘린더와 그래프로 진행 상황을 한눈에 파악하고 성취감을 느낄 수
                  있습니다.
                </p>
              </div>
              <div className="solution-item">
                ...
                <h3>지속적인 동기부여</h3>
                <p>
                  성취율 통계와 트렌드 분석으로 지속적인 동기부여를 받을 수
                  있습니다.
                </p>
              </div>
            </div>
          ...
          <div className="section-content">
            ...
            <div className="features-grid">
              <div className="feature-card">
                ...
                <h3>습관 등록</h3>
                <p>
                  원하는 습관을 쉽게 등록하고 목표와 빈도를 설정할 수 있습니다.
                </p>
              </div>
              <div className="feature-card">
                <div className="feature-icon">✅</div>
                <h3>매일 체크</h3>
                <p>
                  간단한 클릭으로 매일의 습관 완료를 기록하고 성취감을 느낄 수
                  있습니다.
                </p>
              </div>
              <div className="feature-card">
                ...
                <h3>캘린더 시각화</h3>
                <p>
                  달력 형태로 습관 달성 현황을 시각적으로 확인하고 패턴을
                  분석합니다.
                </p>
              </div>
              <div className="feature-card">
                ...
                <h3>통계 확인</h3>
                <p>
                  차트와 그래프로 습관 달성률과 트렌드를 분석하여 개선점을
                  찾습니다.
                </p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-brand">
              <h3 className="footer-brand-container">
                <img
                  src={logo}
                  alt="Building Habit 로고"
              ...
              <p>
                작은 습관이 큰 변화를 만든다. 매일의 작은 실천이 당신의 삶을
                바꿉니다.
              </p>
            </div>
